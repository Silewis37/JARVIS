...
class BoundingBox():
  ...
  class CalibratingMessage():
    def Start(frame1):
      ...
      new_value = True
      with open("D:/Jarvis/src/_settings/deadZoneSettings.json", 'r') as f:
          data = json.load(f)
      ...
      with open("D:/Jarvis/src/_settings/deadZoneSettings.json", 'w') as f:
...
class LeftHand():
  class CheckingLayers():
    def CheckActiveLayer():
      with open("D:/Jarvis/src/_settings/handLayer.json", 'r') as f:
        data = json.load(f)
  ...
  class ChangingLayers():
    ...
    def ChangeHandLayer(layer, lastLayer):
      ...
      with open("D:/Jarvis/src/_settings/handLayer.json", 'w') as f:
          json.dump(data, f, indent=4)
