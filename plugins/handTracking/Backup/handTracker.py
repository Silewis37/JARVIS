...
def main():
  ...
  while True:
      ...
      calibrating = handFunc.BoundingBox.DeadZoneChecking.CalibrationCheck()
      count = 0
      
      if calibrating == True:
          if count < 2000:
            handFunc.BoundingBox.CalibratingMessage.Start(frame)
            count += 1
          if count == 2000:
            handFunc.BoundingBox.CalibratingMessage.Stop()
          ...
          if len(results.multi_handedness) == 2:
            ...
            for i in results.multi_handedness: 
                ...
                if label == 'Left': 
                    ...
                    cv2.line(frame, (thumb_coord_real[0], thumb_coord_real[1]), (midpoint_index[0], midpoint_index[1]), (0, 255, 255), 2)
                    cv2.line(frame, (index_finger_coord_real[0], index_finger_coord_real[1]), (midpoint_index[0], midpoint_index[1]), (0, 255, 255), 2)
                    
                    cv2.line(frame, (thumb_coord_real[0], thumb_coord_real[1]), (midpoint_middle[0], midpoint_middle[1]), (204, 0, 153), 2)
                    cv2.line(frame, (middle_finger_real[0], middle_finger_real[1]), (midpoint_middle[0], midpoint_middle[1]), (204, 0, 153), 2)
                    
                    cv2.line(frame, (thumb_coord_real[0], thumb_coord_real[1]), (midpoint_ring[0], midpoint_ring[1]), (51, 51, 255), 2)
                    cv2.line(frame, (ring_finger_real[0], ring_finger_real[1]), (midpoint_ring[0], midpoint_ring[1]), (51, 51, 255), 2)
                    
                    cv2.line(frame, (thumb_coord_real[0], thumb_coord_real[1]), (midpoint_pinky[0], midpoint_pinky[1]), (0, 153, 51), 2)
                    cv2.line(frame, (pinky_finger_real[0], pinky_finger_real[1]), (midpoint_pinky[0], midpoint_pinky[1]), (0, 153, 51), 2)
                ...
                if right_index == True:
                    handFunc.RightHand.Layer1.leftClick()
                ...
                if right_middle == True:
                    handFunc.RightHand.Layer1.doubleLeftClick()
                ...
                if right_ring == True:
                    handFunc.RightHand.Layer1.middleClick()
                ...
                if right_pinky == True:
                    handFunc.RightHand.Layer1.rightClick()
                ...
                if left_index == True:
                        handFunc.LeftHand.Layer1.swapToDesktop1()
                ...
                if left_middle == True:
                        handFunc.LeftHand.Layer1.swapToDesktop2()
                ...
                if left_ring == True:
                        handFunc.LeftHand.Layer1.swapToDesktop3()
                ...
                if left_pinky == True:
                        handFunc.LeftHand.Layer1.swapToDesktop4()
